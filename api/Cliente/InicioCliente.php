...
<body>
    <form action="../Comercio/procesar_inicio_sesion.php" method="post">
        ...
        <input type="text" id="nombre_cliente" name="nombre_cliente" placeholder="Ingrese Nombre de Usuario" required>
        <label for="clave">
        ...
        <br>
        <a href="../../Registro.php?origen=2" class="button styled-button small right">Crear Cuenta</a>
    </form>
</body>
</html>
